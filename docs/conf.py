# -*- coding: utf-8 -*-
#
# BigARTM documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'BigARTM', u'BigARTM Documentation',
   u'Konstantin Vorontsov', 'BigARTM', 'One line description of project.',
   'Miscellaneous'),
]
